...
<h1 class="text-center">INFORMACION DE NOTAS</h1>
<hr>
<h1 class="text-center"> {{$nota->alumno->nombre}} {{$nota->alumno->apellido}}</h1>

<hr>
<table width="100%" id="myTable" class="display bg-secondary">
